...
base_avatar3 = "https://raw.githubusercontent.com/fexli/ArknightsResource/main/avatar/ASSISTANT/{}.png"
...
def grab_avatar(char):
    ...
    url = base_avatar3.format(fullid)
    target = path.join("images", "avatars3", f"{fullid}.png") 
